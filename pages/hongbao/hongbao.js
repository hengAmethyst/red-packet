...
Page({
    data: {
        ...
        swiperIndex: 0,//swiper 当前的index
        showMark: false,//展示蒙版
        userInfo: null,//个人信息
        nowCurrentIndex: 0,//当前的swiper序号
        bgmUrl: null,//背景音乐
    },
    //-------------------------------------------------节日列表显示相关--------------------------------------------------//
    // 展示公司列表
    ...
    // 选择节气
    chooseFestival(e) {
        console.log(e.currentTarget.dataset.index, '11111')
        console.log(e.currentTarget.dataset.nowfestival.festivalName)
